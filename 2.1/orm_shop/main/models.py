...
class Car(models.Model):
    id=models.CharField('наименование концерна',primary_key = True)
    model=models.CharField('Модель', max_length=50)
    year=models.IntegerField('Год выпуска', default=2020)
    color=models.CharField('Цвет', max_length=40, choices=COLOR_CHOICES)
